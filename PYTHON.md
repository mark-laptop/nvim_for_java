...
- Подсказки параметров автоматически при вводе `(` и `,`; Ctrl-K вызывает их вручную.
- Окна автокомплита и документации с рамками; Tab / Shift-Tab также переходят по полям вставленного snippet.
- Автоимпорты, поиск модулей в src и получение типов из кода библиотек без stubs.
...
| Ctrl-K | Параметры функции (в режиме ввода и normal mode) |
| Ctrl-b / Ctrl-f | Прокрутка документации в окне автокомплита |
